...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'user_menu_label',
            'url' => 'user',
            'icon' => 'fas fa-fw fa-user',
            'can'  => 'user.index', // Verifica a permissão via Gate
            // 'label' => 4,
            // 'label_color' => 'success',
        ],
        [
            'text' => 'profile_menu_label',
            'url' => 'profile',
        ...
        [
            'text' => 'system_menu_label',
            'url' => 'system',
            'icon' => 'fas fa-fw fa-desktop',
            'can'  => 'system.index', 
        ],
        [
            'text' => 'organization_menu_label',
            'url' => 'organization',
