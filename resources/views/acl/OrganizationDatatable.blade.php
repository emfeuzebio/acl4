...
@section('title', __(config('app.name')) . ' ' . __('acl.organization.title'))
                ...
                <div class="modal-body">
                    ...
                    <form id="formEntity" name="formEntity"  action="javascript:void(0)" class="form-horizontal" method="post">
                        ...
                        <div class="form-group" id="form-group-id">
                            <label class="form-label">{{ __('acl.organization.columns.id-name') }}</label>
                            <input class="form-control" value="" type="text" id="id" name="id" placeholder="" readonly data-toggle="tooltip" title="{{ __('acl.organization.columns.id-tip') }}">
                        </div>                         
                        
                        <div class="form-group">
                            <label class="form-label">{{ __('acl.organization.columns.name-name') }}</label>
                            <input class="form-control" value="" type="text" id="name" name="name" placeholder="{{ __('acl.organization.columns.name-placeholder') }}" data-toggle="tooltip" title="{{ __('acl.organization.columns.name-tip') }}" >
                            <div id="error-name" class="error invalid-feedback" style="display: none;"></div>
                        </div>

                        <div class="form-group">
                            <label class="form-label">{{ __('acl.organization.columns.acronym-name') }}</label>
                            <input class="form-control" value="" type="text" id="acronym" name="acronym" placeholder="{{ __('acl.organization.columns.acronym-placeholder') }}" data-toggle="tooltip" title="{{ __('acl.organization.columns.acronym-tip') }}" >
                            <div id="error-acronym" class="error invalid-feedback" style="display: none;"></div>
                        </div>
                        
                        <div class="form-group input-group-sm">
                            <label class="form-label">{{ __('acl.organization.columns.description-name') }}</label>
                            <textarea class="form-control" id="description" name="description" placeholder="{{ __('acl.organization.columns.description-placeholder') }}" data-toggle="tooltip" title="{{ __('acl.organization.columns.description-tip') }}" rows="4"></textarea>
                            <div id="error-description" class="error invalid-feedback" style="display: none;"></div>
                        </div>

                        <div class="form-group input-group-sm">
                            <label class="form-label" data-toggle="tooltip" title="{{ __('acl.organization.columns.active-tip') }}">{{ __('acl.organization.columns.active-name') }}</label>
                            <label class="switch">
